...
</style></head><body><main><section><h1>AWUN<i>.</i></h1><p>WAKING THE SEARCH NETWORK</p><div class="meta"><span>PUBLIC BETA / 1.3</span><span>ONE SEARCH · EVERY SOUND</span></div><div class="line"></div></section></main></body></html>
"""


def open_hosted_app(window: webview.Window) -> None:
    request = Request(f"{AWUN_URL.rstrip('/')}/health", headers={"User-Agent": "AWUN-Desktop/1.3"})
    try:
