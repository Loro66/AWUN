...
- you preserve the package, branding, copyright notices, this license and the
  EULA exactly as supplied;
- you do not imply authorship, endorsement, partnership or official status; and
- you do not distribute API keys, tokens, cookies, user data or media with it.

The copyright holder may withdraw redistribution permission for a distributor
that breaches these conditions. Recipients who obtained a compliant copy keep
their end-user rights unless they separately breach this license.
...
- create, compile, distribute or operate a modified version, fork, derivative
  work, hosted clone or competing service;
- incorporate it into another application, library, service or product;
- publish or privately distribute modified source or binaries;
- sublicense, sell, rent, lease, charge for access to, or otherwise monetize it;
  or
- provide software-as-a-service, managed hosting or white-label access.

Contributions are accepted only under
...
including lawful backup, observation, testing, interoperability or security
research rights where applicable.
...
country and may change without notice.

## 6. Donations

Donations are voluntary support for development and infrastructure. They do
not purchase the Software, music, provider access, downloads, priority service
or any additional license rights. No donation is required for the rights in
Section 1.
...
## 8. Updates, termination and survival

The copyright holder may change, suspend or discontinue the Software or future
free releases. A new license does not retroactively remove rights validly
granted for a release you already received, unless that release or permission
states otherwise.

Your license terminates automatically if you breach these terms. You must then
stop using and distributing the Software and delete unauthorized copies.
Sections concerning ownership, restrictions, third-party rights, disclaimer
and liability survive termination.

## 9. Disclaimer and limitation of liability

THE SOFTWARE IS PROVIDED **“AS IS”** AND **“AS AVAILABLE”**, WITHOUT WARRANTIES
OF ANY KIND TO THE MAXIMUM EXTENT PERMITTED BY LAW. TO THE MAXIMUM EXTENT
PERMITTED BY LAW, THE COPYRIGHT HOLDER IS NOT LIABLE FOR INDIRECT, INCIDENTAL,
SPECIAL, CONSEQUENTIAL OR PUNITIVE DAMAGES, LOSS OF DATA, PROFITS, ACCESS OR
GOODWILL ARISING FROM THE SOFTWARE OR THIRD-PARTY SERVICES.

Nothing in this section excludes liability or consumer rights that applicable
law does not allow to be excluded or limited.

## 10. Permissions and controlling language

For commercial licensing, hosting, modified distribution or other permission,
contact the copyright holder through the verified contact method on the
[Loro66 GitHub profile](https://github.com/Loro66). Do not post secrets in a
public issue.

The English text above is the controlling version. The Russian translation
below is provided for convenience. If the versions conflict, the English text
...
поддержку или будущие обновления.
...
- пакет, бренд, уведомления об авторских правах, эта лицензия и EULA сохранены
  без изменений;
- распространитель не выдаёт себя за автора, партнёра или официальный канал;
- вместе со сборкой не передаются ключи, токены, cookies, данные пользователей
  или медиаматериалы.

Правообладатель может отозвать разрешение у распространителя, нарушившего эти
условия. Пользователи, законно получившие такую копию, сохраняют свои права,
пока сами не нарушают лицензию.
...
код или существенную его часть, чтобы:

- создавать, собирать, распространять или запускать изменённую версию, форк,
  производное произведение, публичный клон или конкурирующий сервис;
- включать код в другое приложение, библиотеку, сервис или продукт;
- публиковать либо приватно распространять изменённый код или сборки;
- выдавать сублицензии, продавать, сдавать в аренду, брать плату за доступ или
  иным образом монетизировать код;
- предоставлять SaaS, управляемый хостинг или white-label версию.

Вклад принимается только на условиях
[CONTRIBUTOR_LICENSE_AGREEMENT.md](CONTRIBUTOR_LICENSE_AGREEMENT.md).
...
включая допустимые законом резервное копирование, наблюдение, тестирование,
обеспечение совместимости и исследование безопасности.
...
Пожертвования добровольно поддерживают разработку и инфраструктуру. Они не
покупают Программу, музыку, доступ к провайдерам, скачивания, приоритетное
обслуживание или дополнительные лицензионные права. Для прав из раздела 1
пожертвование не требуется.
...
## 8. Обновления и прекращение лицензии

Правообладатель может менять, приостанавливать или прекращать Программу и её
будущие бесплатные выпуски. Новая лицензия не отменяет задним числом права,
законно выданные на уже полученный релиз, если в условиях конкретного релиза
прямо не сказано иное.

При нарушении условий лицензия прекращается автоматически. После этого нужно
прекратить использование и распространение и удалить неразрешённые копии.
Положения о собственности, ограничениях, сторонних правах, гарантиях и
ответственности продолжают действовать.

## 9. Отказ от гарантий и ограничение ответственности

ПРОГРАММА ПРЕДОСТАВЛЯЕТСЯ **«КАК ЕСТЬ»** И **«ПО МЕРЕ ДОСТУПНОСТИ»**, БЕЗ
ГАРАНТИЙ В МАКСИМАЛЬНО РАЗРЕШЁННОЙ ЗАКОНОМ СТЕПЕНИ. В МАКСИМАЛЬНО РАЗРЕШЁННОЙ
ЗАКОНОМ СТЕПЕНИ ПРАВООБЛАДАТЕЛЬ НЕ ОТВЕЧАЕТ ЗА КОСВЕННЫЙ, СЛУЧАЙНЫЙ,
СПЕЦИАЛЬНЫЙ ИЛИ ПОСЛЕДУЮЩИЙ УЩЕРБ, ПОТЕРЮ ДАННЫХ, ПРИБЫЛИ, ДОСТУПА ИЛИ
ДЕЛОВОЙ РЕПУТАЦИИ ИЗ-ЗА ПРОГРАММЫ ИЛИ СТОРОННИХ СЕРВИСОВ.

Этот раздел не исключает ответственность и права потребителя, которые нельзя
исключить или ограничить по применимому закону.

## 10. Разрешения и основной язык

Для коммерческой лицензии, хостинга, распространения изменённой версии или
иного разрешения свяжитесь с правообладателем через подтверждённый способ связи
в [профиле Loro66 на GitHub](https://github.com/Loro66). Не публикуйте секреты в
открытых Issues.

Юридически основной текст — английский раздел выше. Русский перевод дан для
удобства. При расхождении применяется английский текст в степени, разрешённой
законом.
