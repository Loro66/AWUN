...
Релиз `v1.10.6` автоматически собирается из `main` через GitHub Actions.
...
| Windows | Выпущенная неподписанная бета | [Скачать v1.10.6](https://github.com/Loro66/AWUN/releases/tag/v1.10.6) |
