...
Релиз `v1.10.4` автоматически собирается из `main` через GitHub Actions.

- **233 Python-теста** проверяют поиск, ranking, matching, policy, надёжность, безопасность и desktop-упаковку.
...
| Windows | Выпущенная неподписанная бета | [Скачать v1.10.4](https://github.com/Loro66/AWUN/releases/tag/v1.10.4) |
