...
Релиз `v2.3.0` автоматически собирается из `main` через GitHub Actions.
...
- **30 Playwright-сценариев** проверяют постепенный поиск, отмену, тайм-аут источника, восстановление воспроизведения, нечёткое сопоставление при переносе медиатеки, звуковые профили, очередь, большие библиотеки и адаптивность.
...
| Windows | Выпущенная неподписанная бета | [Скачать v2.3.0](https://github.com/Loro66/AWUN/releases/tag/v2.3.0) |
