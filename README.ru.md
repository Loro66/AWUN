...
Релиз `v2.2.0` автоматически собирается из `main` через GitHub Actions.
...
- **29 Playwright-сценариев** проверяют постепенный поиск, отмену, тайм-аут источника, восстановление воспроизведения, многострочный перенос медиатеки, звуковые профили, очередь, большие библиотеки и адаптивность.
...
| Windows | Выпущенная неподписанная бета | [Скачать v2.2.0](https://github.com/Loro66/AWUN/releases/tag/v2.2.0) |
